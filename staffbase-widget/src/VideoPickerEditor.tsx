...
const S: Record<string, React.CSSProperties> = {
  ...
  searchIcon:  { position: 'absolute' as any, left: 12, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' as any, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1 },
