...
import {
  VIDEO_WIDGET_ATTRIBUTES,
  VIDEO_WIDGET_BLOCK_LABEL,
  VIDEO_WIDGET_BLOCK_NAME,
} from './constants';
...
const factory: BlockFactory = (BaseBlockClass, widgetApi) => {
  ...
  return class KrogerVideoBlock extends BaseBlockClass implements BaseBlock {
    ...
    public static get observedAttributes(): string[] {
      return VIDEO_WIDGET_ATTRIBUTES;
    }
...
const blockDefinition: BlockDefinition = {
  name: VIDEO_WIDGET_BLOCK_NAME,
  factory,
  attributes: VIDEO_WIDGET_ATTRIBUTES,
  blockLevel: 'block',
  configurationSchema,
  uiSchema,
  label: VIDEO_WIDGET_BLOCK_LABEL,
  iconUrl: icon,
};
